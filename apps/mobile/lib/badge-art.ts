...
function medallion(base: string, tier: number): string {
  ...
  s +=
    '<circle cx="50" cy="50" r="' +
    (r - 3) +
    '" fill="none" stroke="#FFFFFF" stroke-width="1.8" opacity="0.22"/>';
  s +=
    '<circle cx="50" cy="50" r="' +
    (r - 6) +
    '" fill="none" stroke="' +
    INK +
    '" stroke-width="1.6" opacity="0.16"/>';
  if (tier >= 1)
    s +=
      '<circle cx="50" cy="50" r="' +
      (r - 1.5) +
...
function laurel(): string {
  return (
    '<path d="M31 71 C19 62 19 45 30 35" fill="none" stroke="' +
    INK +
    '" stroke-width="3.2" stroke-linecap="round"/>' +
    '<path d="M69 71 C81 62 81 45 70 35" fill="none" stroke="' +
    INK +
    '" stroke-width="3.2" stroke-linecap="round"/>' +
    '<path d="M27 64l-4-2M26 55l-4-2M30 47l-4-3" stroke="' +
    INK +
    '" stroke-width="2.4" stroke-linecap="round"/>' +
    '<path d="M73 64l4-2M74 55l4-2M70 47l4-3" stroke="' +
    INK +
    '" stroke-width="2.4" stroke-linecap="round"/>'
  );
}
...
function medal(t: string, opts?: MedalOpts): string {
  ...
  s +=
    '<circle cx="50" cy="50" r="15" fill="none" stroke="' +
    INK +
    '" stroke-width="1.4" opacity="0.3"/>';
...
const GLYPH: Record<string, (c: string) => string> = {
  first_step: () =>
    '<path d="M50 75 V46"/>' +
    '<path d="M50 61 C36 61 30 51 30 41 C44 41 50 51 50 61 Z" fill="' +
    INK +
    '" stroke="' +
    INK +
    '"/>' +
    '<path d="M50 53 C64 53 70 43 70 33 C56 33 50 43 50 53 Z" fill="' +
    INK +
    '" stroke="' +
    INK +
    '"/>' +
  ...
  high_five: () => {
    const f = INK;
    return (
      '<rect x="37" y="52" width="27" height="20" rx="8" fill="' +
      f +
      '" stroke="none"/>' +
      '<rect x="39" y="40" width="5.4" height="16" rx="2.7" fill="' +
      f +
      '" stroke="none"/>' +
      '<rect x="46" y="35" width="5.4" height="21" rx="2.7" fill="' +
      f +
      '" stroke="none"/>' +
      '<rect x="53" y="37" width="5.4" height="19" rx="2.7" fill="' +
      f +
      '" stroke="none"/>' +
      '<rect x="60" y="41" width="5.4" height="15" rx="2.7" fill="' +
      f +
      '" stroke="none"/>' +
      '<path d="M37 58 C30 55 27 62 33 66 Z" fill="' +
      f +
      '" stroke="none"/>'
    );
  },
  ...
  win100: () =>
    laurel() +
    '<circle cx="50" cy="50" r="21" fill="' +
    GOLD +
    '" stroke="' +
    INK +
    '" stroke-width="4"/>' +
    '<circle cx="50" cy="50" r="16" fill="none" stroke="' +
    INK +
  ...
  bagel: () =>
    ...
    INK +
    '" stroke-width="3"/>' +
    '<circle cx="42" cy="41" r="1.7" fill="' +
    INK +
    '"/><circle cx="59" cy="43" r="1.7" fill="' +
    INK +
    '"/>' +
    '<circle cx="57" cy="59" r="1.7" fill="' +
    INK +
    '"/><circle cx="41" cy="58" r="1.7" fill="' +
    INK +
    '"/>',
  comeback: () =>
    '<polyline points="27,61 42,68 56,53 69,37" fill="none" stroke="' +
    LIME +
    '" stroke-width="5.5"/>' +
    '<path d="M60 37 H70 V47" fill="none" stroke="' +
    LIME +
    '" stroke-width="5.5"/>' +
    '<path d="M40 30 c3 4 5 5 5 9 a4.5 4.5 0 0 1 -9 0 c0 -3 1.5 -4 2 -5 0 2.5 2 2.5 2 -4 z" fill="' +
    GOLD +
    '" stroke="' +
    INK +
    '" stroke-width="2"/>',
  ...
  first_double: (c) =>
    '<path d="M18 45 L34 45 L46 54" stroke="' +
    c +
    '" stroke-width="5" fill="none"/>' +
    '<path d="M82 45 L66 45 L54 54" stroke="' +
    c +
    '" stroke-width="5" fill="none"/>' +
    '<rect x="43" y="48" width="14" height="14" rx="3.5" fill="' +
    c +
    '" stroke="none"/>' +
    '<rect x="13" y="41" width="8" height="9" rx="2" fill="' +
    c +
    '" stroke="none"/>' +
    '<rect x="79" y="41" width="8" height="9" rx="2" fill="' +
    c +
    '" stroke="none"/>',
  partners5: () =>
  ...
  opponents10: () =>
    ...
    '<path d="M48 23 v11 M42.5 28.5 h11" stroke="' +
    LIME +
    '" stroke-width="5"/>',

  top10: () =>
    '<path d="M30 73 C18 64 18 46 27 36" fill="none" stroke="' +
    INK +
    '" stroke-width="3.4" stroke-linecap="round"/>' +
    '<path d="M70 73 C82 64 82 46 73 36" fill="none" stroke="' +
    INK +
    '" stroke-width="3.4" stroke-linecap="round"/>' +
    star(50, 24, 6, 2.5, GOLD, INK, 2) +
    num('10', INK, 54),
  top3: () =>
    '<rect x="32" y="56" width="13" height="15" fill="' +
    W +
    '" stroke="' +
    INK +
    '" stroke-width="3.4"/>' +
    '<rect x="43.5" y="43" width="13" height="28" fill="' +
    W +
    '" stroke="' +
    INK +
    '" stroke-width="3.4"/>' +
    '<rect x="55" y="62" width="13" height="9" fill="' +
    W +
    '" stroke="' +
    INK +
    '" stroke-width="3.4"/>' +
  ...
  champion: () =>
    '<path d="M25 60 L31 33 L42 48 L50 29 L58 48 L69 33 L75 60 Z" fill="' +
    W +
    '" stroke="' +
    INK +
    '" stroke-width="4" stroke-linejoin="round"/>' +
    '<path d="M25 64 H75" stroke="' +
    INK +
    '" stroke-width="4.5" stroke-linecap="round"/>' +
    '<circle cx="31" cy="33" r="3" fill="' +
    GOLD +
    '" stroke="' +
    INK +
    '" stroke-width="2"/>' +
    '<circle cx="50" cy="29" r="3.6" fill="' +
    PINK +
    '" stroke="' +
    INK +
    '" stroke-width="2"/>' +
    '<circle cx="69" cy="33" r="3" fill="' +
    GOLD +
    '" stroke="' +
    INK +
    '" stroke-width="2"/>' +
  ...
  yearly_champ: () =>
    '<path d="M35 29 H65 V40 C65 53 58 59 50 59 C42 59 35 53 35 40 Z" fill="' +
    W +
    '" stroke="' +
    INK +
    '" stroke-width="4" stroke-linejoin="round"/>' +
    '<path d="M35 32 C27 32 26 45 37 47" fill="none" stroke="' +
    INK +
    '" stroke-width="3.4"/>' +
    '<path d="M65 32 C73 32 74 45 63 47" fill="none" stroke="' +
    INK +
    '" stroke-width="3.4"/>' +
    '<rect x="46" y="59" width="8" height="9" fill="' +
    W +
    '" stroke="' +
    INK +
    '" stroke-width="3.4"/>' +
    '<rect x="35" y="68" width="30" height="7" rx="2" fill="' +
    W +
    '" stroke="' +
    INK +
    '" stroke-width="3.4"/>' +
  ...
  night_owl: () =>
    '<path d="M34 30 L41 41 M66 30 L59 41" stroke="' +
    W +
    '" stroke-width="5" stroke-linecap="round"/>' +
    '<circle cx="50" cy="52" r="22" fill="none" stroke="' +
    W +
    '" stroke-width="5"/>' +
    '<circle cx="42" cy="48" r="8" fill="' +
    W +
    '" stroke="none"/><circle cx="42" cy="48" r="3.2" fill="' +
    BLUE +
    '"/>' +
    '<circle cx="58" cy="48" r="8" fill="' +
    W +
    '" stroke="none"/><circle cx="58" cy="48" r="3.2" fill="' +
    BLUE +
    '"/>' +
    '<path d="M46 56 L50 63 L54 56 Z" fill="' +
    GOLD +
    '" stroke="none"/>' +
    '<path d="M40 71 L46 65 M60 71 L54 65" stroke="' +
    W +
    '" stroke-width="4" stroke-linecap="round"/>',
  early_bird: () =>
    '<circle cx="61" cy="38" r="7" fill="' +
    W +
    '" stroke="' +
    INK +
    '" stroke-width="3"/>' +
    '<path d="M61 25 v-5 M61 56 v-3 M48 38 h-5 M74 38 h5 M52 29 l-3 -3 M70 29 l3 -3 M52 47 l-3 3 M70 47 l3 3" stroke="' +
    INK +
    '" stroke-width="2.6" stroke-linecap="round"/>' +
    '<path d="M27 60 Q37 50 45 60 Q53 50 61 60" fill="none" stroke="' +
    INK +
    '" stroke-width="5" stroke-linecap="round"/>' +
    '<path d="M30 71 Q50 65 70 71" fill="none" stroke="' +
    INK +
    '" stroke-width="4" stroke-linecap="round"/>',
  court_lover: () =>
    '<path d="M50 16 c-3 -3 -9 -1 -9 4 c0 5 9 10 9 10 c0 0 9 -5 9 -10 c0 -5 -6 -7 -9 -4 z" fill="' +
    W +
    '" stroke="' +
    INK +
    '" stroke-width="2.4"/>' +
    '<rect x="30" y="35" width="40" height="37" rx="4" fill="none" stroke="' +
    W +
    '" stroke-width="4.5"/>' +
    '<path d="M30 53.5 H70" stroke="' +
    W +
    '" stroke-width="3.4"/>' +
    '<path d="M50 35 V72" stroke="' +
    W +
    '" stroke-width="2.4" opacity="0.7"/>' +
    '<path d="M41 44 H59 M41 63 H59" stroke="' +
    W +
    '" stroke-width="2.4" opacity="0.7"/>',
  globetrotter: () =>
    '<path d="M50 30 C40 30 33 38 33 48 C33 60 50 75 50 75 C50 75 67 60 67 48 C67 38 60 30 50 30 Z" fill="' +
    W +
    '" stroke="' +
    INK +
    '" stroke-width="4" stroke-linejoin="round"/>' +
    '<circle cx="50" cy="47" r="7" fill="' +
    BLUE +
    '" stroke="' +
    INK +
    '" stroke-width="3"/>' +
    '<circle cx="26" cy="71" r="2.4" fill="' +
    W +
    '"/><circle cx="33" cy="74" r="2.4" fill="' +
    W +
    '"/><circle cx="41" cy="75" r="2.4" fill="' +
    W +
    '"/>',
  marathon: () =>
    '<circle cx="59" cy="29" r="6" fill="' +
    INK +
    '" stroke="none"/>' +
    '<path d="M59 36 L49 50 L40 59 M49 50 L61 55 L64 67" fill="none" stroke="' +
    INK +
    '" stroke-width="5"/>' +
    '<path d="M58 41 L67 38 M58 41 L47 45" stroke="' +
    INK +
    '" stroke-width="5"/>' +
    '<path d="M21 38 H32 M19 48 H33 M23 58 H30" stroke="' +
    INK +
  ...
  founder: () =>
    '<path d="M32 36 L50 23 L68 36 Z" fill="' +
    GOLD +
    '" stroke="' +
    INK +
    '" stroke-width="3" stroke-linejoin="round"/>' +
    '<rect x="33" y="38" width="34" height="6" rx="1.5" fill="' +
    W +
    '" stroke="' +
    INK +
    '" stroke-width="3"/>' +
    '<rect x="40" y="44" width="20" height="22" fill="' +
    W +
    '" stroke="' +
    INK +
    '" stroke-width="3"/>' +
    '<path d="M46 44 V66 M50 44 V66 M54 44 V66" stroke="' +
    INK +
    '" stroke-width="2"/>' +
    '<rect x="33" y="66" width="34" height="6" rx="1.5" fill="' +
    W +
    '" stroke="' +
    INK +
    '" stroke-width="3"/>',
