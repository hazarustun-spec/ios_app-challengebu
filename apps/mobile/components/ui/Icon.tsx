...
//
// The thunk receives `(color, fill)` so every shape can carry the stroke
// color directly. Setting `stroke` only on the parent `<Svg>` relies on
// inheritance through react-native-svg's wrapper `<G>`, which is fragile on
// iOS — some Path strokes silently fall back to the platform default (black),
// which is the original Phase C TabBar bug where active/center icons rendered
// dark instead of white. Pushing the color all the way down to each shape
// eliminates the inheritance dependency.
//
...
type IconRenderer = (color: string, fill: string) => ReactNode;
...
const ICONS = {
  ...
  matches: (c, f) => (
    <>
      ...
      <Path key="1" d="M3 12h18M8 5v14" stroke={c} fill={f} />
    </>
  ),
  bell: (c, f) => (
    <>
  ...
  user: (c, f) => (
    <>
      <Circle key="0" cx={12} cy={8} r={4} stroke={c} fill={f} />
      <Path key="1" d="M4 21a8 8 0 0 1 16 0" stroke={c} fill={f} />
    </>
  ),
  plus: (c, f) => <Path key="0" d="M12 5v14M5 12h14" stroke={c} fill={f} />,

  // ---------------- arrows / chevrons ----------------
  back: (c, f) => <Path key="0" d="M15 5l-7 7 7 7" stroke={c} fill={f} />,
  chevR: (c, f) => <Path key="0" d="M9 5l7 7-7 7" stroke={c} fill={f} />,
  ...
  compass: (c, f) => (
    <>
      ...
      <Path key="1" d="M15.5 8.5l-2 5-5 2 2-5z" stroke={c} fill={f} />
    </>
  ),
  people: (c, f) => (
    <>
  ...
  checkCircle: (c, f) => (
    <>
      <Circle key="0" cx={12} cy={12} r={9} stroke={c} fill={f} />
      <Path key="1" d="M8 12l3 3 5-6" stroke={c} fill={f} />
    </>
  ),
  x: (c, f) => <Path key="0" d="M6 6l12 12M18 6L6 18" stroke={c} fill={f} />,
  xCircle: (c, f) => (
    <>
      <Circle key="0" cx={12} cy={12} r={9} stroke={c} fill={f} />
  ...
  search: (c, f) => (
    <>
      ...
      <Path key="1" d="M21 21l-4-4" stroke={c} fill={f} />
    </>
  ),
  edit: (c, f) => (
    <>
      <Path key="0" d="M4 20h4L19 9l-4-4L4 16z" stroke={c} fill={f} />
      <Path key="1" d="M14 6l4 4" stroke={c} fill={f} />
    </>
  ),
  settings: (c, f) => (
    <>
      <Circle key="0" cx={12} cy={12} r={3} stroke={c} fill={f} />
      <Path
        key="1"
  ...
  calendar: (c, f) => (
    <>
      <Rect key="0" x={3} y={5} width={18} height={16} rx={2} stroke={c} fill={f} />
      <Path key="1" d="M3 9h18M8 3v4m8-4v4" stroke={c} fill={f} />
    </>
  ),
  clock: (c, f) => (
    <>
      <Circle key="0" cx={12} cy={12} r={9} stroke={c} fill={f} />
      <Path key="1" d="M12 7v5l3 2" stroke={c} fill={f} />
    </>
  ),
  pin: (c, f) => (
    <>
  ...
  trophy: (c, f) => (
    <>
      <Path key="0" d="M7 4h10v4a5 5 0 0 1-10 0z" stroke={c} fill={f} />
      <Path
        key="1"
  ...
  medal: (c, f) => (
    <>
      <Circle key="0" cx={12} cy={14} r={6} stroke={c} fill={f} />
      <Path key="1" d="M9 3l3 5 3-5" stroke={c} fill={f} />
    </>
  ),
  ...
  share: (c, f) => (
    <>
      <Circle key="0" cx={18} cy={5} r={3} stroke={c} fill={f} />
      <Circle key="1" cx={6} cy={12} r={3} stroke={c} fill={f} />
      <Circle key="2" cx={18} cy={19} r={3} stroke={c} fill={f} />
      <Path key="3" d="M8.5 10.5l7-4m0 11l-7-4" stroke={c} fill={f} />
    </>
  ),
  ban: (c, f) => (
    <>
      <Circle key="0" cx={12} cy={12} r={9} stroke={c} fill={f} />
      <Path key="1" d="M5.6 5.6l12.8 12.8" stroke={c} fill={f} />
    </>
  ),
  snow: (c, f) => (
    <Path
  ...
  camera: (c, f) => (
    <>
      <Rect key="0" x={3} y={7} width={18} height={13} rx={2} stroke={c} fill={f} />
      <Circle key="1" cx={12} cy={13.5} r={3.5} stroke={c} fill={f} />
      <Path key="2" d="M8 7l1.5-3h5L16 7" stroke={c} fill={f} />
    </>
  ),
  phone: (c, f) => (
    <Path
  ...
  mail: (c, f) => (
    <>
      <Rect key="0" x={3} y={5} width={18} height={14} rx={2} stroke={c} fill={f} />
      <Path key="1" d="M3 7l9 6 9-6" stroke={c} fill={f} />
    </>
  ),
  link: (c, f) => (
    <Path
  ...
  grid: (c, f) => (
    <>
      <Rect key="0" x={3} y={3} width={7} height={7} rx={1.5} stroke={c} fill={f} />
      <Rect key="1" x={14} y={3} width={7} height={7} rx={1.5} stroke={c} fill={f} />
      <Rect key="2" x={3} y={14} width={7} height={7} rx={1.5} stroke={c} fill={f} />
      <Rect key="3" x={14} y={14} width={7} height={7} rx={1.5} stroke={c} fill={f} />
    </>
  ),
  sun: (c, f) => (
    <>
      <Circle key="0" cx={12} cy={12} r={4} stroke={c} fill={f} />
      <Path
        key="1"
  ...
  info: (c, f) => (
    <>
      <Circle key="0" cx={12} cy={12} r={9} stroke={c} fill={f} />
      <Path key="1" d="M12 11v5m0-8.5v.5" stroke={c} fill={f} />
    </>
  ),
  warn: (c, f) => (
    <>
      <Path key="0" d="M12 3l9 16H3z" stroke={c} fill={f} />
  ...
  dots: (c, f) => (
    <>
      <Circle key="0" cx={5} cy={12} r={1.6} stroke={c} fill={f} />
      <Circle key="1" cx={12} cy={12} r={1.6} stroke={c} fill={f} />
      <Circle key="2" cx={19} cy={12} r={1.6} stroke={c} fill={f} />
    </>
  ),
  lock: (c, f) => (
    <>
      <Rect key="0" x={5} y={11} width={14} height={9} rx={2} stroke={c} fill={f} />
      <Path key="1" d="M8 11V8a4 4 0 0 1 8 0v3" stroke={c} fill={f} />
    </>
  ),
  eye: (c, f) => (
    <>
